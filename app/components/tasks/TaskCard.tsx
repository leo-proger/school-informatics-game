  ...
  return (
    <button
      ...
      className={`
        ...
        ${locked ? "border-white/10 bg-black/40 opacity-50 cursor-not-allowed" : ""}
    ...
    >
      ...
      <div className="relative h-full flex flex-col justify-between p-7">
        <div className="flex justify-between items-start">
          <div>
            <div className="text-xs tracking-[4px] text-cyan-300/60">
              MODULE
            </div>
          ...
          <div
            ...
            style={{
              background: completed ? "#4ade80" : active ? "#22d3ee" : "#555",
              boxShadow: completed
                ? "0 0 15px #4ade80"
                : active
                ? "0 0 15px #22d3ee"
        ...
        <div className="flex justify-between items-center">
          <div className="text-cyan-300/50 text-xs tracking-[3px]">
            PHOENIX://TASK
          </div>
